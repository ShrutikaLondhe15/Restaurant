                    ...
                    <div id="reserve" class="form-container">
                        ...
                        <div class="mb-3">
                             <h2>Reservation List</h2>
                                 <!-- <label for="itemName" class="form-label">Reservation Details</label> -->
                              <p id="name"></p><br>
                                <p id="email"></p><br>
                                 <p id="datetime"></p><br>
                                <p id="select1"></p><br>
                        ...
                        <button name="Reserve Seat" class="btn btn-outline-warning px-2" onclick="document.location='admindash.php'">Reserve Seat</button>
                        <button name="Reserve Seat" class="btn btn-outline-warning px-2" onclick="document.location='admindash.php'">Delete Request</button>
                    </form> 
                    </div>
...
function retrieveData() {
      ...
      if (storedData) {
       ...
       var parentElem= document.getElementById('name')
       var childElem = document.createElement('span');
       childElem.style.fontSize='15px'
       childElem.textContent="Name : "+ formData.name;
        parentElem.appendChild(childElem);

        //email
        document.getElementById('email').value = formData.email;
        var parentElem= document.getElementById('email')
        var childElem = document.createElement('p');
        childElem.style.fontSize='15px'
        childElem.textContent="Email id : "+ formData.email;
        parentElem.appendChild(childElem);

        //datetime
        document.getElementById('datetime').value = formData.datetime;
        var parentElem= document.getElementById('datetime')
        var childElem = document.createElement('p');
        childElem.style.fontSize='15px'
        childElem.textContent="Date Time : "+ formData.datetime;
        parentElem.appendChild(childElem);

        //people
        document.getElementById('select1').value = formData.select1;
        var parentElem= document.getElementById('select1')
        var childElem = document.createElement('p');
        childElem.style.fontSize='15px'
        childElem.textContent="No. of people: "+ formData.select1;
        parentElem.appendChild(childElem);

        //msg
        document.getElementById('message').value = formData.message;
        var parentElem= document.getElementById('message')
        var childElem = document.createElement('p');
        childElem.style.fontSize='15px'
        childElem.textContent="Special Request : "+ formData.message;
        parentElem.appendChild(childElem);
      }
    }
